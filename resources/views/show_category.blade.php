...
<body class="home blog hfeed parent-home">
  <div id="page" class="site">
    ...
    {{-- <div class="card grid__item ms-5 d-none d-md-block d-lg-block" style="width: 24rem;">
      <img class="card-img-top" src="{{ asset('public/image/'.$each_post->featured_image) }}" alt="Card image cap">
      <div class="card-body">
        <h5 class="card-title" style="font-size: 30px; font-weight: bold">{{ $each_post->post_title }}</h5>
        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
          content.</p>
        <a href="/post/{{ $each_post->id }}" class="btn btn-primary">Read More...</a>
      </div>
    </div> --}}
    ...
    {{-- <div class="d-flex justify-content-center">
      <div class="card grid__item d-md-none d-lg-none" style="width: 20rem;">
        <img class="card-img-top" src="{{ asset('public/image/'.$each_post->featured_image) }}" alt="Card image cap">
        <div class="card-body">
